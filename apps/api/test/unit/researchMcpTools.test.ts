      ...
      result: {
        ...
        items: [{
          ...
          sourceFacts: {
            companyName: "測試公司",
            industryName: "半導體業",
            currentMonthRevenue: { state: "present", value: "1000" },
            priorMonthRevenue: { state: "present", value: "990" },
            priorYearSameMonthRevenue: { state: "present", value: "900" },
            publisherComparisons: {
              monthOverMonthPercent: { state: "present", value: "1.01" },
