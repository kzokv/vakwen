...
- Repository regression gate completed:
  ...
  - web unit tests: 1,350 passed, 2 skipped across the split run;
...
- Final review regressions cover first-call memory-store initialization without crossing the full-store boundary and concurrent final-account deletion with owner-serialized reporting fallback.
