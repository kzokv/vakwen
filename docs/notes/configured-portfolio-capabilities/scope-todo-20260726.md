...
- Repository regression gate completed:
  ...
  - web unit tests: 1,348 passed, 2 skipped across the split run;
  - API unit and memory-backed integration tests: 2,191 passed, 501 skipped;
  - managed PostgreSQL integration tests: 1,143 passed, 1 skipped;
