...
- Worker side: the financial-statement acquisition worker resolves descriptors at run time and feeds only official MOPS artifacts into the acquisition entrypoint.
